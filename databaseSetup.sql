...
CREATE USER 'user'@'%' IDENTIFIED WITH mysql_native_password AS 'user1234';GRANT SELECT, INSERT, UPDATE, DELETE ON *.* TO 'user'@'%' REQUIRE NONE WITH MAX_QUERIES_PER_HOUR 0 MAX_CONNECTIONS_PER_HOUR 0 MAX_UPDATES_PER_HOUR 0 MAX_USER_CONNECTIONS 0;GRANT ALL PRIVILEGES ON `chasingcravings`.* TO 'user'@'%';
